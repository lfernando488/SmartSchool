...
namespace SmartSchool.API.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Disciplinas",
                columns: new[] { "Id", "MyProperty", "Nome", "ProfessorId1" },
                values: new object[] { 1, 1, "Matemática", null });

            migrationBuilder.InsertData(
                table: "Disciplinas",
                columns: new[] { "Id", "MyProperty", "Nome", "ProfessorId1" },
                values: new object[] { 5, 5, "Programação", null });

            migrationBuilder.InsertData(
                table: "Disciplinas",
                columns: new[] { "Id", "MyProperty", "Nome", "ProfessorId1" },
                values: new object[] { 4, 4, "Inglês", null });

            migrationBuilder.InsertData(
                table: "Disciplinas",
                columns: new[] { "Id", "MyProperty", "Nome", "ProfessorId1" },
                values: new object[] { 3, 3, "Português", null });

            migrationBuilder.InsertData(
                table: "Disciplinas",
                columns: new[] { "Id", "MyProperty", "Nome", "ProfessorId1" },
                values: new object[] { 2, 2, "Física", null });
